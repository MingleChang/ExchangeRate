...
-(UIImage *)resetToScale:(CGFloat)scale{
    return [self resetToScaleWidth:scale andScaleHeight:scale];
}

-(UIImage *)resetToScaleWidth:(CGFloat)scaleW{
    return [self resetToScaleWidth:scaleW andScaleHeight:1.0];
}

-(UIImage *)resetToScaleHeight:(CGFloat)scaleH{
    return [self resetToScaleWidth:1.0 andScaleHeight:scaleH];
}
